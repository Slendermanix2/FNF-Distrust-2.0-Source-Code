...
class NotesSubstate extends MusicBeatSubstate
{
	...
	public function new() {
		...
		for (i in 0...ClientPrefs.arrowHSV.length) {
			...
			switch(i) {
				case 0:
					note.animation.addByPrefix('idle', 'purple alone');
				case 1:
					note.animation.addByPrefix('idle', 'blue alone');
				case 2:
					note.animation.addByPrefix('idle', 'green alone');
				case 3:
					note.animation.addByPrefix('idle', 'red alone');
			}
