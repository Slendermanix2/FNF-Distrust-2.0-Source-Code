...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Unstopable",		"Beat Humerus on Genocide with no Misses.",				'week0_nomiss_genocide',			false],
		["Unbeatable!",		"Beat Humerus on FDY with no Misses.",				'week0_nomiss_fdy',			false],
		["Not Hungry At All!",				"Complete Humerus without using health items",				'no_hunger',			false],
		["Smh Skill issue",			"Die 69 times",				'skill_issue',			false],
		["Dissus",					"Beat 'A Sansationl Battle'",				'dissus',			true],
		["Dying Is Gay",			"???",				'dyingIsGayCode10',			true],
		["Sus",					"???",				'susCode10',			true],
		["???",		"???",				'staticCode10',			 true],
		["The Super Secret Acheivment",	"???",	'super_secret_code9',				true],
		["Big Shot??",				"???",			'bigShotCode10',				true],
		["Star Valley Star",			"???",			'starValleyCode10',	true],
