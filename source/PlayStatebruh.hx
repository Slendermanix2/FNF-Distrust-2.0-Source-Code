...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		butterscotchPie = new FlxSprite(150, 600).loadGraphic(Paths.image('butterscotch_Pie'));
		butterscotchPie.updateHitbox();
		butterscotchPie.scrollFactor.set();

		instantNoodles = new FlxSprite(150, 635).loadGraphic(Paths.image('instant_Noodles'));
		instantNoodles.updateHitbox();
		instantNoodles.scrollFactor.set();

		legendaryHero = new FlxSprite(150, 660).loadGraphic(Paths.image('legendary_Hero'));
		...
		switch (curStage)
		{
			...
			case 'sansbruh': //Week 1
			
				var bg:BGSprite = new BGSprite('background', -700, -350, 0.9, 0.9, ['Background', 'Purple']);
				bg.scale.x = 5;
				add(bg);
				...
				new FlxTimer().start(0.01, function(tmr:FlxTimer)
					{
						if(bg.y == -950) 
						{
							...
							if(bg.animation.curAnim.name == 'Background')
							{
								bg.animation.play('Purple');
							}
							else if(bg.animation.curAnim.name == 'Purple')
							{
								bg.animation.play('Background');
							}	
						}	
				...
				{
					var bg:BGSprite = new BGSprite('swapSansBackground', -625, -400, 1, 1);
					bg.updateHitbox();
					add(bg);
	...
	override public function update(elapsed:Float)
	{
		...
		if (hitbox2.overlaps(boyfriend) && boyfriend.dodgetime > 12)
		{
			health -= 100;
		}
